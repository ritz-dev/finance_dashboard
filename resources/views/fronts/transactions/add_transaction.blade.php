      ...
      <div class="row">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{url('finance/transactions')}}"><button type="button" class="btn btn-md btn-outline-danger">Back</button></a>
            </div>
            <div class="card-body">
                <form action="{{url('finance/tran_store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="mt-2" id="add-transaction-detail">
